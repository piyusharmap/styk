...
export const MORNING_GREET_MSG = "Morning, Captain! Here's what's planned for today.";
export const AFTERNOON_GREET_MSG = 'Good afternoon, Captain! Keep up the momentum today.';
export const EVENING_GREET_MSG = "Evening, Captain! Let's finish strong today.";
export const NIGHT_GREET_MSG = "Late night, Captain! Let's wrap up today's tasks.";
